...
const ftetbeja = require("../assets/images/ftetbeja.jpg");
const Chakchouka = require("../assets/images/chakchouka.jpg");
const couscousSardine = require("../assets/images/couscoussardine4.jpg");
const markahloua = require("../assets/images/MarkaHloua.jpg");
const chebtia = require("../assets/images/Chebtia.jpg");
const kafteji = require("../assets/images/kafteji.jpg");
const banadhej = require("../assets/images/banadhej.jpg");
const tchichblkarnit = require("../assets/images/1.jpg");
const rechta =require("../assets/images/Rechta.jpg");
const borzguen = require("../assets/images/Borzguen.jpg");
const mchalwich =require("../assets/images/mcalwich-cuisine-tunisienne.jpg");
export default {
    borzguen,
    rechta,
    mchalwich,
